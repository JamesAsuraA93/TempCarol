            ...
            <nav className="md:flex md:items-center md:justify-between p-1.5 px-4 bg-[#EDE7D7] ">
                <div>
                    <div className='flex justify-between items-center'>
                        {/* LOGO */}
                        <span className='flex-col mr-2.5'>
                        ...
                        {/*Search*/}
                        <form className='max-w-[75%] min-w-[50%] relative '>
                ...
                <div>
                    <div className={`leading-[80px] flex-1 justify-self-center pb-1 mt-8 md:block md:pb-0 md:mt-0 ${
                        navbar ? 'p-2 md:p-0 block ' : 'hidden'
                    }`}>
                        <ul className='fixed md:relative md:flex md:item-center md:pb-0 pb-12 md:z-auto left-0 w-full md:w-auto md:pl-0 pl-4 '>
